	...
	<section class="content_area_section">
    	<div class="container">
        	<div class="row">
                ...
                if($is_sidebar==='' || $is_sidebar==='true' && $sidebar_pos!=='sidebar_left' && $sidebar_pos!=='sidebar_2left' && ($sidebar_pos==='sidebar_right' || $sidebar_pos==='sidebar_both' || $sidebar_pos==='sidebar_2right') ){
				?>
                <!-- right sidebar starts --> 
                <aside>
                	<div class="<?php echo $sidebar_width; ?>">
