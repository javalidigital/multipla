...
class wedding_style_typography_page_class{
	...
	function __construct(){
		...
		$this->shorttypography = $wedding_style_special_id_for_db."ty";	
	...
	public function dorado_theme_admin_typography(){
		...
		<tr>   
                      <td style="font-size:14px; font-weight:bold">
					     <a href="<?php echo esc_url($wedding_style_web_dor).'/wordpress-themes-guide-step-1.html'; ?>" target="_blank" style="color:#126094; text-decoration:none;">User Manual</a><br />This section allows you to change the font styles.
                         <a href="<?php echo esc_url($wedding_style_web_dor).'/wordpress-theme-options/3-7.html'; ?>" target="_blank" style="color:#126094; text-decoration:none;">More...</a>
			          </td>   
		...
		<div>
			...
			<div>
				...
				<?php $wedding_style_admin_helepr_functions->select_with_label($this->options_typography['type_headers_font'],$class='fontselector'); ?>
				</div>
				<div>
					...
					<div id="type_headers_set_styling" class="font_styling type_inputs optioninputtextarea" style="height: 110px;">
						<div class="type_select">
							<?php $wedding_style_admin_helepr_functions->select_with_label($this->options_typography['type_headers_kern'],$class='letter_spacing'); ?>
						</div>
						<div class="type_select">
							<?php $wedding_style_admin_helepr_functions->select_with_label($this->options_typography['type_headers_transform'],$class='text_transform'); ?>
						</div>
						<div class="type_select">
							<?php $wedding_style_admin_helepr_functions->select_with_label($this->options_typography['type_headers_variant'],$class='font_variant'); ?>
						</div>
						<div class="type_select">
							<?php $wedding_style_admin_helepr_functions->select_with_label($this->options_typography['type_headers_weight'],$class='font_weight'); ?>
						</div>
						<div class="type_select">
							<?php $wedding_style_admin_helepr_functions->select_with_label($this->options_typography['type_headers_style'],$class='font_style'); ?>
						</div>
						<div class="clear"></div>
					</div>
				</div>
		...
		<div>
			<div class="optiontitle">
				...
				<div>
					<div class="optioninput" style=" font-size:13pt;">
						<?php $wedding_style_admin_helepr_functions->select_with_label($this->options_typography['type_primary_font'],$class='fontselector'); ?>
					<div>
				</div>
			</div>
			<div class="font_preview_wrap">
			...
			<div id="_type_primary__set_styling" class="font_styling type_inputs optioninputtextarea" style="height:110px;">
						<div class="type_select">
							<?php $wedding_style_admin_helepr_functions->select_with_label($this->options_typography['type_primary_kern'],$class='letter_spacing'); ?>
						</div>
						<div class="type_select">
							<?php $wedding_style_admin_helepr_functions->select_with_label($this->options_typography['type_primary_transform'],$class='text_transform'); ?>
						</div>
						<div class="type_select">
							<?php $wedding_style_admin_helepr_functions->select_with_label($this->options_typography['type_primary_variant'],$class='font_variant'); ?>
						</div>
						<div class="type_select">
							<?php $wedding_style_admin_helepr_functions->select_with_label($this->options_typography['type_primary_weight'],$class='font_weight'); ?>
						</div>
						<div class="type_select">
							<?php $wedding_style_admin_helepr_functions->select_with_label($this->options_typography['type_primary_style'],$class='font_style'); ?>
						</div>
				<div class="clear"></div>
			</div>
		</div>
		...
		<br/>
			<div>
				...
				<div>
					<div class="optioninput" style=" font-size:13pt;">
						<?php $wedding_style_admin_helepr_functions->select_with_label($this->options_typography['type_inputs_font'],$class='fontselector'); ?>
					</div>
					<div>
						<div class="font_preview_wrap">
							<label class="typagrphy_label" for="" style="font-size:18px;font-size: 20px;font-family: Segoe UI;">Preview</label>
						...
						<div class="type_select">
							<?php $wedding_style_admin_helepr_functions->select_with_label($this->options_typography['type_inputs_kern'],$class='letter_spacing'); ?>
						</div>
						<div class="type_select">
							<?php $wedding_style_admin_helepr_functions->select_with_label($this->options_typography['type_inputs_transform'],$class='text_transform'); ?>
						</div>
						<div class="type_select">
							<?php $wedding_style_admin_helepr_functions->select_with_label($this->options_typography['type_inputs_variant'],$class='font_variant'); ?>
						</div>
						<div class="type_select">
							<?php $wedding_style_admin_helepr_functions->select_with_label($this->options_typography['type_inputs_weight'],$class='font_weight'); ?>
						</div>
						<div class="type_select">
							<?php $wedding_style_admin_helepr_functions->select_with_label($this->options_typography['type_inputs_style'],$class='font_style'); ?>
						</div>
						<div class="clear"></div>
						</div>
