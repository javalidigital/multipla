<?php 
class wedding_style_web_buis_adv extends WP_Widget
{
    function wedding_style_web_buis_adv(){
...
<?php if ($bannerTitle[$key] == '') $bannerTitle[$i] = "advertisement";
	...
	<a href="<?php echo esc_url($bannerUrl[$key]); ?>" ><img src="<?php echo esc_url($bannerPath[$key]); ?>" alt="<?php echo esc_url($bannerAlt[$key]); ?>" title="<?php echo $bannerTitle[$key]; ?>" /></a>
<?php };
					}
echo $after_widget;
...
}// end wedding_style_web_buis_adv class
add_action('widgets_init', create_function('', 'return register_widget("wedding_style_web_buis_adv");'))
?>