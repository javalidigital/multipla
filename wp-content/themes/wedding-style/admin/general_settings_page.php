...
class wedding_style_general_settings_page_class{
	...
	function __construct(){
		...
		global $wedding_style_special_id_for_db, $wedding_style_web_dor;
		/// initial params
		$this->generalsettings = "General Settings";
		$this->shortgeneralsettings = $wedding_style_special_id_for_db."";
		...
		$value_of_std[17] = get_theme_mod($this->shortgeneralsettings."_footer_text", '<span id="copyright">WordPress Themes by <a href="'.$wedding_style_web_dor.'/wordpress-themes/wedding-style.html"  target="_blank" title="Web-Dorado">Web-Dorado</a></span>');
		...
		$this->options_generalsettings = array(
			...
			'grab_image' => array(
				...
				"description" => "Enable this option if you want to use the images that are already in your post to create a thumbnail without using custom fields. In this case thumbnail images will be generated automatically using the first added image of the post. Note that the image needs to be hosted on your own server.",
		...
		if ( isset($_GET['page']) && $_GET['page'] ==  "web_dorado_theme" && isset($_GET['controller']) && $_GET['controller'] == "general_page") {
			if (isset($_REQUEST['action']) && $_REQUEST['action'] == 'save') {
				foreach ($this->options_generalsettings as $value) {
					$sanitize_type='wedding_style_do_nothing';
	...
	public function dorado_theme_admin_general_settings(){
		...
		<div id="main_general_page">
			<table align="center" width="90%" style="margin-top: 0px;">
			    <tr>
					<td>
						<h2 style="margin:15px 0px 0px;font-family:Segoe UI;padding-bottom: 10px;color: rgb(111, 111, 111); font-size:28pt;">General</h3>
					</td>
				</tr>
				<tr>   
                    <td style="font-size:14px; font-weight:bold; padding-left: 5px;">
					    <a href="<?php echo esc_url($wedding_style_web_dor).'/wordpress-themes-guide-step-1.html'; ?>" target="_blank" style="color:#126094; text-decoration:none;">User Manual</a><br />This section allows you to make changes in your site and customize it in accordance to personal preferences.
                        <a href="<?php echo esc_url($wedding_style_web_dor).'/wordpress-theme-options/3-3.html'; ?>" target="_blank" style="color:#126094; text-decoration:none;">More...</a>
					</td>  
				...
				<table align="center" width="90%" style=" padding-bottom:0px; padding-top:0px;">
					<tr>
						<td>
							...
							<?php 
							$wedding_style_admin_helepr_functions->only_textarea($this->options_generalsettings['custom_css']); 
							$wedding_style_admin_helepr_functions->only_upload($this->options_generalsettings['logo_img']);
							$wedding_style_admin_helepr_functions->checkbox_with_upload($this->options_generalsettings['favicon_enable'],$this->options_generalsettings["favicon_img"]); 
							$wedding_style_admin_helepr_functions->only_checkbox($this->options_generalsettings['blog_style']); 
							$wedding_style_admin_helepr_functions->only_checkbox($this->options_generalsettings['grab_image']); 
							$wedding_style_admin_helepr_functions->checkbox_with_input($this->options_generalsettings['show_twitter_icon'],$this->options_generalsettings['twitter_url']); 
							$wedding_style_admin_helepr_functions->checkbox_with_input($this->options_generalsettings['show_rss_icon'],$this->options_generalsettings['rss_url']); 
							$wedding_style_admin_helepr_functions->checkbox_with_input($this->options_generalsettings['show_facebook_icon'],$this->options_generalsettings['facebook_url']); 
							$wedding_style_admin_helepr_functions->only_checkbox($this->options_generalsettings['date_enable']); 
							$wedding_style_admin_helepr_functions->only_textarea($this->options_generalsettings['footer_text']); 
							?>
							</div>		
						</td>
					</tr>
