<?php
class wedding_style_layout_page_class{
	...
	function __construct(){
		...
		$this->shortthemeoptions = $wedding_style_special_id_for_db."gs";
		...
		<form method="post" action="themes.php?page=web_dorado_theme&controller=layout_page">
			<table align="center" width="90%" style="margin-top: 0px;">
				<tbody>
				    <tr>
						<td>
							<h2 style="margin:15px 0px 0px;font-family:Segoe UI;padding-bottom: 10px;color: rgb(111, 111, 111); font-size:28pt;">Layout Editor</h2>
						</td>						
					</tr>
					<tr>   
				...
				<tbody>
					<tr>
						<td>
						    ...
						    <div>
								<?php	$wedding_style_admin_helepr_functions->only_checkbox($this->options_themeoptions['full_width']); ?>
								<?php for($i=0;$i<$count_text;$i++) {
									$wedding_style_admin_helepr_functions->only_input($text[$i],array("input_size"=>"4"));
								 } 			
								 ?>
