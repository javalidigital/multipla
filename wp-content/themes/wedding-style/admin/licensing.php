...
class wedding_style_licensing_page_class{
...
public function dorado_theme_admin_licensing(){
global $wedding_style_web_dor;
?>

<div id="main_licensing_page" style="width: 95%;margin: 0 auto;"> 
<p>
This theme is the non-commercial version of the Wedding Style theme. You will be able to use it free of charge. It comes with a large number of features. Some of the advanced features are not available for this option. If you want to use those features, you are required to purchase a license.</p>
...
<td>
<div class="buy_theme" style="float:left;"><a href="<?php echo esc_url($wedding_style_web_dor).'/wordpress-themes/wedding-style.html'; ?>" target="_blank"><div></div></a></div>
</td>
</tr>
</tbody>
</table>
